                ...
                <div className='flex justify-between'>
                    <div className = "flex justify-center">
                        ...
                        <div className = "ml-0 sm:ml-2 mb-1"> 
                            ...
                            <button onClick = {()=>{setDropDown(dropDown == "" ? "hidden": "")}} id="dropdownDefaultButton" data-dropdown-toggle="dropdown" className=" h-8   dark:text-white  dark:bg-gray-200 dark:hover:bg-blue-800 focus:ring-4 focus:outline-none dark:focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center bg-gray-500 hover:bg-blue-700 focus:ring-blue-800" type="button">Days <svg className="w-4 h-4 ml-2" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg></button>
